...
def entrypoint():
    ...
    parser.add_argument(
        ...
        default="tetris_3",
        choices=["tetris_1", "tetris_2", "tetris_3", "tetris_5", "book_shelf", "blocks", "unpack", "pouring", "stirring"],
    )
    parser.add_argument(
    ...
    # Robot and grasp
    parser.add_argument("--robot", default="panda", choices=["panda", "ur5", "fr5"], help="Robot to use")
    parser.add_argument(
        "--grasp_dof",
        type=int,
        default=4,
